...
use crate::{
    builder::EntityBuilderComponentTracker, prelude::Entity, resource::Resource, TypeIdWrapper,
};
...
{
    pub fn new(instrs: &'a W, known_component_types: &'a BTreeSet<TypeIdWrapper>) -> Self {
        Self {
            instrs,
